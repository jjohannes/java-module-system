...
- **Example project (Application):** [java-modules-example-app](java-modules-example-app)
- **Example project (Library):** [java-modules-example-library](java-modules-example-library)
